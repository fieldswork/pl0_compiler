...
lexeme *lexanalyzer(char *input)
{
	...
	for (i = 0; input[i] != '\0'; i++)
	{
		...
		else if (isalpha(input[i]))
		{
			...
			// Reserved word: if
			else if (input[i+0] == 'i' && input[i+1] == 'f' && !isalpha(input[i+2]) && !isdigit(input[i+2]))
			{
			...
			// Reserved word: then
			else if (input[i+0] == 't' && input[i+1] == 'h' && input[i+2] == 'e' && 
					 input[i+3] == 'n' && !isalpha(input[i+4]) && !isdigit(input[i+4]))
			{
			...
			// Reserved word: else
					 ...
					 input[i+3] == 'e' && !isalpha(input[i+4]) && !isdigit(input[i+4]))
			{
			...
			// Reserved word: begin
			else if (input[i+0] == 'b' && input[i+1] == 'e' && input[i+2] == 'g' && 
					 input[i+3] == 'i' && input[i+4] == 'n' && !isalpha(input[i+5]) && !isdigit(input[i+5]))
			{
			...
			// Reserved word: end
			else if (input[i+0] == 'e' && input[i+1] == 'n' && input[i+2] == 'd' && !isalpha(input[i+3]) && !isdigit(input[i+3]))
			{
		...
		else if (input[i] == '=')
		{
			...
			// If the next character of input after = is not another =, invalid symbol error.
			else
			{
				printlexerror(1);
				return NULL;
